...
#RSP=`curl -k -i -X POST -H "Accept-Encoding: deflate" -H "Content-Type: text/xml; charset=UTF-8" -H 'SOAPAction: ""' -H "Host: 200.111.44.187:10005" --data "$REQ" --location "https://200.111.44.187:10005/imed/ImedWebService" -u ImedWebRole:ImedWebRole`
