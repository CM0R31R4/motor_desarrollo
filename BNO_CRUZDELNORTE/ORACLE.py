...
#os.environ['LD_LIBRARY_PATH']='/home/motor/instantclient_10_2'
import cx_Oracle10g


if os.environ.get('LD_LIBRARY_PATH', '').find('/home/motor/instantclient_10_2') < 0:
    print "ADVERTENCIA: ejecute: export LD_LIBRARY_PATH=/home/motor/instantclient_10_2"
    sys.exit(1)
...
class OracleInterface:
	...
	type_obj = getattr(cx_Oracle10g, type_name)
	if array_size:
