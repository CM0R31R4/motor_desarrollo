...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/servicios/wsCertificacion.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">wsCertificacion</p><br>

      

      <span>

          <p class="intro">Las operaciones siguientes son compatibles. Para una definición formal, revise la <a href="wsCertificacion.asmx?WSDL">descripción de servicios</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="wsCertificacion.asmx?op=wmImed_SrvCertificacion">wmImed_SrvCertificacion</a>
