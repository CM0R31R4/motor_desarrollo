...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/Certificacion/Certificacion.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">Certificacion</p><br>

      

      <span>

          <p class="intro">Las operaciones siguientes son compatibles. Para una definición formal, revise la <a href="Certificacion.asmx?WSDL">descripción de servicios</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="Certificacion.asmx?op=wmImed_SrvCertificacion">wmImed_SrvCertificacion</a>
