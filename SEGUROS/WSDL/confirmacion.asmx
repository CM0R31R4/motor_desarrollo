...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/produccionmpro/confirmacion.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <span>
          ...
          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="confirmacion.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="confirmacion.asmx?op=wmImed_SrvConfirmacion">wmImed_SrvConfirmacion</a>
                
                <span>
                  <br>MPRO: Confirma Liquidación
                </span>
              </li>
              <p>
