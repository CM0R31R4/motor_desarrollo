...
{
	char *wmImed_USCORESrvAnulacionResult;	/* required element of type xsd:string */
};
#endif

#ifndef SOAP_TYPE_ns1__wmImed_USCORESrvAnulacion_Response
#define SOAP_TYPE_ns1__wmImed_USCORESrvAnulacion_Response (12)
/* ns1:wmImed_SrvAnulacion-Response */
struct ns1__wmImed_USCORESrvAnulacion_Response
{
...
/* ns1:wmImed_SrvAnulacion */
struct ns1__wmImed_USCORESrvAnulacion_
{
	struct ns1__wmImed_USCORESrvAnulacion *XML_USCOREINPUT;	/* optional element of type ns1:wmImed_SrvAnulacion */
};
#endif
...
SOAP_FMAC5 int SOAP_FMAC6 ns1__wmImed_USCORESrvAnulacion_(struct soap*, struct ns1__wmImed_USCORESrvAnulacion *XML_USCOREINPUT, char **wmImed_USCORESrvAnulacionResult);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_ns1__wmImed_USCORESrvAnulacion_(struct soap*);
