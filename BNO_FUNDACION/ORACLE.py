...
class OracleInterface:
	...
	try:
	    ...
	    return json.dumps({'result': final_result, 'API_CODRESPUESTA' : "1", 'API_TIPO' : "ORACLE", 'xx_final_xx' :"**fin**"  }, sort_keys=True, default=json_value_mapper)
	...
	#Si hay otro error
	    ...
	    log("Otro Error", traceback.format_exc())
	    #Cancelo Timeout
	    t.cancel()
            return "REINTENTE"
