...
int DecToBase81(char szOut[],char *pcStringIn, int iLenOut)
{
	...
	printf("B81 LenStr=%i %s iLenOut=%i\n\r",iLenStr,acStringOut,iLenOut);
	...
	if (iLenStr < iLenOut )
	{
		...
		printf("B81 %s %s %s",acStringOut,acPaso,acAuxHex);
	}
...
unsigned long Base81ToDec(char *pcBase80)
{
	int		i;
