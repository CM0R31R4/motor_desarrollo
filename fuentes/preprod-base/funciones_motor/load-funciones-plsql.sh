...
psql -d motor -f bono3_registra_tx.sql
psql -d motor -f bono3_update_tx.sql
...
psql -d motor -f responde_xml_error.sql
...
psql -d motor -f correlativo_solicfolios.sql
psql -d motor -f responde_http_scgi.sql
psql -d motor -f get_campo.sql
psql -d motor -f put_campo.sql
psql -d motor -f sp_procesa_respuesta_cola_bonos.sql
psql -d motor -f correlativos_puertos_fin_oracle.sql
