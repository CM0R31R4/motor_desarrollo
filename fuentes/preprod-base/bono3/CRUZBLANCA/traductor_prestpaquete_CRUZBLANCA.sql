CREATE OR REPLACE FUNCTION traductor_in_prestpaquete_cruzblanca(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
CREATE OR REPLACE FUNCTION traductor_out_prestpaquete_cruzblanca(varchar)
returns varchar as
$$
declare
        xml1		alias for $1;
...
begin
	...
	--Parseo el 2do Select
        ...
        xml2:=logapp(xml2,'CRUZBLANCA: RSP_PRESTPAQUETE -> extCodError='||cod_resp1||' -extMensajeError='||mensaje_resp1||' -extCodHomologo='||cod_homol1||' -extItemHomologo='||item_homol1||' -extCantidad='||cantidad1);
