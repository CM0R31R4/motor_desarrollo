...
/* 
 ...
 verificacion de vigencia para atributo BadTerAdi_fc cuando
  ...
  Referencia   : FR 5484. Reemplazo de los servicios de cobertura y calculo de bonificacion, 
  		 además incorporar servicio para verificar excepcion de copago fijo de convenio.
  -- ** ------------------------------------------------------------------------------------- 
  Fecha        : Marzo de 2012
  Autor        : MHV
...
@cor_car, @extPlan
 ...
 begin 
   ...
   begin 
      ...
      begin 
          Select @extCodError = 'N' 
          Select @extMensajeError = 'Pqte en mßs de 1 espec/no conv.' --TRX DENEGADA (EI:400378) 
          if @FlagLogError = 1
