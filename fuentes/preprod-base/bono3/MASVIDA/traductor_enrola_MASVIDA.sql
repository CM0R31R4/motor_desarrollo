CREATE OR REPLACE FUNCTION traductor_in_enrola_masvida(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
CREATE OR REPLACE FUNCTION traductor_out_enrola_masvida(varchar)
returns varchar as
$$
declare
        xml1		alias for $1;
...
begin
	...
	xml2:=logapp(xml2,'MAS_VIDA: RSP_ENROLA -> extValido='||cod_resp1||' -extNombreComp='||nombre1);
