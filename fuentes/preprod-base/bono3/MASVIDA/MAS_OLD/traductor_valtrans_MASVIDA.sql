...
begin
	...
	exec_sp:= 'execute dbo.MASvaltrans '||cod_fin1||','||folio_fin1||',['||accion1||'],['||pregunta1||'], @extRespuesta OUTPUT, @extCodError OUTPUT, @extMensajeError OUTPUT ';
	/*Ejemplo*/ 
	--exec_sp:= exec  dbo.MASvaltrans 78, 15721115, 'C', 'V',@extRespuesta output, @extCodError output, @extMensajeError output;
