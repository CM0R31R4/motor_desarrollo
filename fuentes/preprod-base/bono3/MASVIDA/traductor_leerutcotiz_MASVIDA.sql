CREATE OR REPLACE FUNCTION traductor_in_leerutcotiz_masvida(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	exec_sp:= 'execute dbo.MASLeeRutCotiz '||cod_fin1||',"'||rut_cotiz1||'", @extNomCotizante OUTPUT, @extCodError OUTPUT, @extMensajeError OUTPUT; ';
	/*Ejemplo*/ 
	--exec_sp:= dbo.MASLeeRutCotiz 88, '0009702357-3', @extNomCotizante output, @extCodError output, @extMensajeError output;
...
CREATE OR REPLACE FUNCTION traductor_out_leerutcotiz_masvida(varchar)
returns varchar as
$$
declare
        xml1		alias for $1;
