CREATE OR REPLACE FUNCTION bono3.traductor_in_valorvari_rioblanco(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	extCodFinanciador       := trim(get_campo('EXTCODFINANCIADOR',xml2));
        ...
        rut_conv1          := split_part(ltrim(get_campo('EXTRUTBENEFICIARIO',xml2),'0'),'-',1);
        ...
        extLista7               := coalesce(nullif(get_campo('EXTLISTA7',xml2),''),'0');
	...
	xml2:=put_campo(xml2,'INPUT','["IRB_ADMIMED.RBLVALORVARI_PKG.RBLVALORVARI", [ "$o$STRING", '||extCodFinanciador||', '||chr(34)||extHomNumeroConvenio||chr(34)||', '||chr(34)||extHomLugarConvenio||chr(34)||', '||chr(34)||extSucVenta||chr(34)||', '||chr(34)||rut_conv1||chr(34)||', '||chr(34)||rut_tratante1||chr(34)||', '||chr(34)||extEspecialidad||chr(34)||', '||chr(34)||rut_solic1||chr(34)||', '||chr(34)||rut_benef1||chr(34)||', '||chr(34)||extTratamiento||chr(34)||', '||chr(34)||extCodigoDiagnostico||chr(34)||', '||chr(34)||extNivelConvenio||chr(34)||', '||chr(34)||extUrgencia||chr(34)||', '||chr(34)||extLista1||chr(34)||', '||chr(34)||extLista2||chr(34)||', '||chr(34)||extLista3||chr(34)||', '||chr(34)||extLista4||chr(34)||', '||chr(34)||extLista5||chr(34)||', '||chr(34)||extLista6||chr(34)||','||chr(34)||extLista7||chr(34)||', '||chr(34)||extNumPrestaciones||chr(34)||', "$o$STRING", "$o$STRING", "$o$STRING", "$o$STRING", "$o$STRING", "$o$STRING", "$o$STRING", "$o$STRING", "$o$NUMBER[12]", "$o$NUMBER[12]", "$o$NUMBER[12]", "$o$STRING[15]", "$o$NUMBER[2]", "$o$NUMBER[12]", "$o$NUMBER[2]", "$o$NUMBER[12]", "$o$NUMBER[2]", "$o$NUMBER[12]", "$o$NUMBER[2]", "$o$NUMBER[12]", "$o$NUMBER[2]", "$o$NUMBER[12]" ]]'||chr(10)||chr(10));
...
CREATE OR REPLACE FUNCTION bono3.traductor_out_valorvari_rioblanco(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
