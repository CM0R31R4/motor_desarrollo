...
SQL> SQL> PROCEDURE BANVALIDACAT
 ...
 EXTFECHANACIMIENTO		DATE			IN
 EXTCODSEXO			VARCHAR2		IN
 EXTFECHAINICIO 		DATE			IN
 EXTFECHATERMINO		DATE			IN
 ...
 OUT_EXTRESPUESTACAT		VARCHAR2		OUT
 OUT_EXTMENSAJECAT		VARCHAR2		OUT

SQL> 
TEXT
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
PACKAGE 	   Banvalidacat_Pkg IS
/**********************************************************************************************
 DAM, 15/12/2003.
