CREATE OR REPLACE FUNCTION traductor_in_leerutcotiz_cchc(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
CREATE OR REPLACE FUNCTION traductor_out_leerutcotiz_cchc(varchar)
returns varchar as
$$
declare
        xml1		alias for $1;
