...
begin
	...
	--Si es un beneficiario certificado
		...
		--Fecha viene asi "196811090000000000000". Con Filler
	...
	--xml2:=put_campo(xml2,'EXTFECHANACIMI',	trim(substr( replace(json_field(aux1,'5'),'"',''),1,8)));
