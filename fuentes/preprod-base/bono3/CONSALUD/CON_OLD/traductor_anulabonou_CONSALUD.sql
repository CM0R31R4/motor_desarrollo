...
begin
	...
	extCodFinanciador       := trim(get_campo('EXTCODFINANCIADOR',xml2));
        ...
        xml2:=put_campo(xml2,'INPUT','["IMEDSOF.CONANULABONOU_PKG.CONANULABONOU", [ "$o$STRING", '||extCodFinanciador||', '||extFolioBono||', '||chr(34)||extIndTratam||chr(34)||', '||chr(34)||extFecTratam||chr(34)||', "$o$STRING", "$o$STRING"]]'||chr(10)||chr(10));
