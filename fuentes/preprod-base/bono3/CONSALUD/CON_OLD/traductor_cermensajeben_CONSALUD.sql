...
begin
	...
	if length(rut_benef1)>'0' then rut_benef1:=lpad(rut_benef1,10,'0')||'-'||motor_modulo11(rut_benef1);end if;
        ...
        xml2:=put_campo(xml2,'INPUT','["IMEDSOF.CONCERMENSAJEBEN_PKG.CONCERMENSAJEBEN", [ "$o$STRING", '||extCodFinanciador||', '||chr(34)||rut_benef1||chr(34)||', "$o$NUMBER", "$o$STRING" ]]'||chr(10)||chr(10));
