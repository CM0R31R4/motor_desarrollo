...
begin
	...
	--Valida formato del Rut
        ...
        xml2:=put_campo(xml2,'SQLINPUT','["IMEDSOF.CONMENSAJEBEN_PKG.CONMENSAJEBEN", [ "$o$STRING", '||cod_fin1||', '||chr(34)||rut_ben1||chr(34)||', "$o$NUMBER", "$o$STRING","$o$STRING" ]]'||chr(10)||chr(10));
...
begin
	...
	xml2:=logapp(xml2,'CONSALUD: RSP_CERMENSAJEBEN -> extTipoAccion1='||tipo_accion1||' -extMsgError1='||msg_error1||' -extMsgError2='||msg_error2);
