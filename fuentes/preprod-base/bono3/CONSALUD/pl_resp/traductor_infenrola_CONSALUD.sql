CREATE OR REPLACE FUNCTION bono3.traductor_in_infenrola_consalud(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	cod_fin1 	:= trim(get_campo('EXTCODFINANCIADOR',xml2));
        ...
        id_enrola1	:= coalesce(nullif(get_campo('EXTINDENROLA',xml2),''),'0');
...
CREATE OR REPLACE FUNCTION bono3.traductor_out_infenrola_consalud(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
