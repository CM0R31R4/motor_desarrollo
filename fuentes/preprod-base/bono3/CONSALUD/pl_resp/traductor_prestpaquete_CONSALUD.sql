...
begin
	...
	cod_fin1	:= get_campo('EXTCODFINANCIADOR',xml2);
        ...
        cod_paquete1    := coalesce(nullif(get_campo('EXTCODPAQUETE',xml2),''),'0');
	...
	--xml2:=put_campo(xml2,'SQLINPUT','["IMEDSOF.CONPRESTPAQUETE_PKG.CONPRESTPAQUETE", [ "$o$STRING", '||cod_fin1||','||chr(34)||num_conv1||chr(34)||','||chr(34)||lugar_conv1||chr(34)||','||chr(34)||cod_paquete1||chr(34)||', "$o$STRING","$o$STRING" ]]'||chr(10)||chr(10));
