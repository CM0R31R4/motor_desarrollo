...
begin
	...
	cod_fin1	:= trim(get_campo('EXTCODFINANCIADOR',xml2));
        ...
        nom_prest1	:= coalesce(nullif(get_campo('EXTNOMPRESTADOR',xml2),''),'0');
        ...
        dscto_planilla1	:= coalesce(nullif(get_campo('EXTDESCUENTOXPLANILLA',xml2),''),'0');
        monto_exec1	:= coalesce(nullif(get_campo('EXTMONTOEXCEDENTE',xml2),''),'0');
        ...
        folio_financ1	:= coalesce(nullif(get_campo('EXTFOLIOFINANCIADOR',xml2),''),'0');
        monto_valor1	:= coalesce(nullif(get_campo('EXTMONTOVALORTOTAL',xml2),''),'0');
        monto_aporte1	:= coalesce(nullif(get_campo('EXTMONTOAPORTETOTAL',xml2),''),'0');
        monto_copago1	:= coalesce(nullif(get_campo('EXTMONTOCOPAGOTOTAL',xml2),''),'0');
        num_opera1	:= coalesce(nullif(get_campo('EXTNUMOPERACION',xml2),''),'0');
        corr_presta1	:= coalesce(nullif(get_campo('EXTCORRPRESTACION',xml2),''),'0');
        tipo_solic1	:= coalesce(nullif(get_campo('EXTTIPOSOLICITUD',xml2),''),'0');
        ...
        plan1		:= coalesce(nullif(get_campo('EXTPLAN',xml2),''),'0');
