CREATE OR REPLACE FUNCTION traductor_in_leerutcotiz_vidacamara(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	exec_sp:= 'execute dbo.NMDLeeRutCotiz '||cod_fin1||',"'||rut_cotiz1||'", @extNomCotizante OUTPUT, @extCodError OUTPUT, @extMensajeError OUTPUT; ';
...
CREATE OR REPLACE FUNCTION traductor_out_leerutcotiz_vidacamara(varchar)
returns varchar as
$$
declare
        xml1		alias for $1;
