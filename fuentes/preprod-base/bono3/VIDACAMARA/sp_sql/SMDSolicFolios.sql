...
SMDSolicFolios	dbo	stored procedure	Apr  5 2012 08:51AM
(1 row affected)
...
@extCodError	char	1	1	NULL	3	Modern_Spanish_CI_AS
@extMensajeError	char	30	30	NULL	4	Modern_Spanish_CI_AS
(4 rows affected)
(return status = 0)
1> 