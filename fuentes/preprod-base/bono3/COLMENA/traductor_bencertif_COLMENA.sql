	...
	--Puede Venir + de 1 Rut
        while true loop
			...
			--Quito la ultima coma (ya que no volvera al ciclo) y se sale
				...
				--xml2:=logapp(xml2,'COLMENA: RSP_BENCERTIF -> i='||i::varchar||' -rut_acompa1='||rut_acompa1||' -nom_acompa1='||nom_acompa1);
                        end if;	
                        exit;
                end if;
                i:=i+1;
