...
--Especifica el nú mámo de oyentes de red permitido por Adaptive Server a la vez
sp_configure "max number network listeners"
go

--Especifica el nú de conecciones remotas
--Especifica el nú de conexiones logicas que pueden estar abiertos hacia y desde un servidor Adaptive Server a la vez
sp_configure "number of remote connections"
go

--Especifica el nú mámo de ingresos de usuarios remotos
--controla el nú de conexiones de usuario activas de Adaptive Server en servidores remotos
sp_configure "number of remote logins"
go

--Especifica cuáos sitios remotos puede accesar el servidor al mismo tiempo
--determina el nú mámo de sitios remotos que pueden acceder a Adaptive Server de forma simultáa
sp_configure "number of remote sites"
go

--Especifica cuáos sitios remotos puede accesar el servidor al mismo tieompo  
--establece el nú mámo de conexiones de usuario que se puede conectar a Adaptive Server al mismo tiempo
