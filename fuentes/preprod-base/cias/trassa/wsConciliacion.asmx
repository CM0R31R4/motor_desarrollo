...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/wsMapfre/Servicios/wsConciliacion.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">wsConciliacion</p><br>

      

      <span>

          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="wsConciliacion.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="wsConciliacion.asmx?op=wmImed_SrvConciliacion">wmImed_SrvConciliacion</a>
