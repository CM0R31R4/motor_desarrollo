...
begin
	...
	exec_sp:= 'EXECUTE dbo.CERRELHMQPROT '||get_campo('CTACORRREGISTRO',xml2)||',
			...
			['||get_campo('CTACODINTER',xml2)||'],
			['||get_campo('CTACODPRESTA',xml2)||'],
			['||get_campo('CTACODITEM',xml2)||'],
			'||get_campo('CTANROINTENVEN',xml2)||',
			['||get_campo('CTAFECATE',xml2)||'],
			['||get_campo('CTAHORAATE',xml2)||'],
			['||get_campo('CTARUTPTD',xml2)||'],
