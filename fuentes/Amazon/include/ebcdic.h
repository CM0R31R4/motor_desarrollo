static unsigned char a2e[256] = {
	...
	0xf8,0xf9,0x7a,0x5e,0x4c,0x7e,0x63,0x6f,
	0x7c,0xc1,0xc2,0xc3,0xc4,0xc5,0xc6,0xc7,
	0xc8,0xc9,0xd1,0xd2,0xd3,0xd4,0xd5,0xd6,
	0xd7,0xd8,0xd9,0xe2,0xe3,0xe4,0xe5,0xe6,
	0xe7,0xe8,0xe9,0xad,0xe0,0xdb,0x5f,0x6d,
...
unsigned char* atobcd(unsigned char*, int);
unsigned char a2ebcdic(const unsigned char c);
unsigned char ebcdic2a(const unsigned char c);
...
/*
unsigned char* atobcd( unsigned char* Texto, int Lng ) {
	int idx = 0;
	int i = 0;
	unsigned char szAux[50];
	...
	for ( i = 0; i <= Lng; i += 2 ) {
		...
		szAux[idx] <<= 4;
		if ( ( i + 1 ) <= Lng )
			szAux[idx++] |= Texto[i + 1] - '0';
		else
			szAux[idx++] |= 0x0f;
	}
	memcpy( Texto, szAux, idx );
