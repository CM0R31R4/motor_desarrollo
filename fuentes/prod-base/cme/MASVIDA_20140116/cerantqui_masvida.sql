CREATE OR REPLACE FUNCTION traductor_in_cerantqui_masvida(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	xml2:=proc_parser_input_cerantqui(xml2);
	...
	--Por ahora en duro
        ...
        exec_sp:= 'EXECUTE dbo.cerantqui '||get_campo('ANAMTIPODET',xml2)||',
                        ...
                        '||get_campo('ANAMCODANTQUIR',xml2)||',
                        ['||get_campo('ANAMANTQUIR',xml2)||'],
                        ['||get_campo('ANAMFECINTER',xml2)||'], @AnamCodError OUTPUT, @AnamMensajeError OUTPUT ';
...
CREATE OR REPLACE FUNCTION traductor_out_cerantqui_masvida(varchar)
returns varchar as
$$
declare
        xml1            alias for $1;
...
begin
        ...
        raise notice 'JCC_cerantqui_RECEIVE AnamCodError=% - AnamMensajeError=%',cod_resp1,msj_resp1;
