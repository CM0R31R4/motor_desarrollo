...
*/
CREATE OR REPLACE FUNCTION sp_input_cia_cbvida_concilia(character varying)
...
begin
        ...
        --Log del input
        xml2:=logapp(xml2,'Input.cbvida.Concilia='||input1);
        ...
        xml2:=put_campo(xml2,'CIA_SOAPACTION','http://Seguros.CruzBlanca.cl/WsIntegracionLGM/Conciliacion');
        return xml2;
end;
$function$
