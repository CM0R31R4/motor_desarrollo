delete from isys_querys_tx where llave='4012';

insert into isys_querys_tx values ('4012',10,1,1,'select proc_monitor_financiadores_4012(''$$__XMLCOMPLETO__$$'') as __XML__',0,0,0,1,1,-1,0);

--Parsea el WS para identificar la transacciones entrante
CREATE OR REPLACE FUNCTION proc_monitor_financiadores_4012(varchar)
returns varchar as
$$
declare
        xml1    	alias for $1;
...
begin
	...
	xml2:=logapp(xml2,'Monitor Financiadores');
...
.amarillo {background: yellow;}
	...
	respuesta1:=respuesta1||'<META HTTP-EQUIV="refresh" CONTENT="300"><H1>Monitor Financiadores '||to_char(now(),'YYYY/MM/DD HH24:MI')||'</H1>';
	respuesta1:=respuesta1||'<div class="datagrid"><table border="1"><tr>';
	--Titulos	
	respuesta1:=respuesta1||'<thead><tr><th align="center">Financiador</th><th align="center">Nombre</th><th align="center">total_ok_5_min</th><th align="center">total_rechazo_5_min</th><th align="center">total_timeout_5_min</th><th align="center">Total en Cola</th></tr></thead>';
	clase1:='';
