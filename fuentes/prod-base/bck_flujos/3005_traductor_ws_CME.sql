...
begin
	...
	if (tipo_tx1 = 'iniciotx') or (tipo_tx1 = 'fintx') or (tipo_tx1 = 'anulatx') then
        ...
        xml2:=ctamed_update_tx(xml2);
	raise notice 'JCC_3005_RESP_5 tipo_tx1=% - Mens=% - Cod_Resp=% - CodMotor=% - CodCme=% ',tipo_tx1,get_campo('MENSAJE_RESP',xml2),get_campo('CODIGO_RESP',xml2),get_campo('CODIGO_MOTOR',xml2),get_campo('COD_CME',xml2);
	raise notice 'JCC_3005_RESPUESTA =% ',stData.respuesta;
