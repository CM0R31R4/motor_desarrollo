...
begin
	...
	cod_fin1        :=get_campo('EXTCODFINANCIADOR',xml2);
        ...
        nom_prest1      :=elimina_tildes(convert_escape(coalesce(nullif(get_campo('EXTNOMPRESTADOR',xml2),''),'0')));
...
begin
	...
	xml2:=logapp(xml2,'FONASA: RSP_ENVBONO -> extCodError='||cod_resp1||' -extMensajeError='||mensaje_resp1);
