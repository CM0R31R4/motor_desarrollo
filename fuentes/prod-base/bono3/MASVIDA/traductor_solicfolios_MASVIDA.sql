CREATE OR REPLACE FUNCTION traductor_in_solicfolios_masvida(character varying)
returns varchar as
$$
declare
        xml1    alias for $1;
...
CREATE OR REPLACE FUNCTION traductor_out_solicfolios_masvida(character varying)
returns varchar as
$$
declare
        xml1            alias for $1;
...
begin
	...
	while true loop
        ...
        xml2:=logapp(xml2,'MAS_VIDA: RSP_SOLICFOLIOS -> extCodError='||cod_resp1||' -extMensajeError='||mensaje_resp1||' -extFoliosDevueltos='||folios_resp1);
