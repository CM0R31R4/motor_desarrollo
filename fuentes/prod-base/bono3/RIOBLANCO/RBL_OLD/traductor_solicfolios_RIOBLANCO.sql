CREATE OR REPLACE FUNCTION bono3.traductor_in_solicfolios_rioblanco(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	xml2    :=put_campo(xml2,'__SECUENCIAOK__','0');
        ...
        xml2:=put_campo(xml2,'INPUT','["IRB_ADMIMED.RBLSOLICFOLIOS_PKG.RBLSOLICFOLIOS", ["$o$STRING", '||extCodFinanciador||', '||extNumFolios||', "$o$STRING", "$o$STRING", "$o$NUMBER[10]"]]'||chr(10)||chr(10));
...
CREATE OR REPLACE FUNCTION bono3.traductor_out_solicfolios_rioblanco(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
