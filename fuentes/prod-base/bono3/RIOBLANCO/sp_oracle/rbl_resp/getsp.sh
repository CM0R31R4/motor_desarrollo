...
SET PAGESIZE 999 LINESIZE 999;
desc RBLANULABONOU_PKG
EOT
cat <<EOT | $SQLPLUS $USR/$PWD@"(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=$HOST)(PORT=$PORT))(CONNECT_DATA=(SID=$SID)))" > $DIR/RBLANULABONOU_PKG_BODY.sql
SET PAGESIZE 999 LINESIZE 999;
SELECT text from all_source where name ='RBLANULABONOU_PKG' and type in('PACKAGE BODY') and OWNER='ADMIMED_CONV' order by line asc;
EOT
...
SET PAGESIZE 999 LINESIZE 999;
desc RBLBENCERTIF_PKG
EOT
cat <<EOT | $SQLPLUS $USR/$PWD@"(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=$HOST)(PORT=$PORT))(CONNECT_DATA=(SID=$SID)))" > $DIR/RBLBENCERTIF_PKG_BODY.sql
SET PAGESIZE 999 LINESIZE 999;
SELECT text from all_source where name ='RBLBENCERTIF_PKG' and type in('PACKAGE BODY') and OWNER='ADMIMED_CONV' order by line asc;
EOT
...
desc RBLENROLA_PKG
EOT
cat <<EOT | $SQLPLUS $USR/$PWD@"(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=$HOST)(PORT=$PORT))(CONNECT_DATA=(SID=$SID)))" > $DIR/RBLENROLA_PKG_BODY.sql
SET PAGESIZE 999 LINESIZE 999;
SELECT text from all_source where name ='RBLENROLA_PKG' and type in('PACKAGE BODY') and OWNER='ADMIMED_CONV' order by line asc;
EOT
...
SET PAGESIZE 999 LINESIZE 999;
desc RBLENVBONIS_PKG
EOT
cat <<EOT | $SQLPLUS $USR/$PWD@"(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=$HOST)(PORT=$PORT))(CONNECT_DATA=(SID=$SID)))" > $DIR/RBLENVBONIS_PKG_BODY.sql
SET PAGESIZE 999 LINESIZE 999;
SELECT text from all_source where name = 'RBLENVBONIS_PKG' and type in('PACKAGE BODY') and OWNER='ADMIMED_CONV' order by line asc;
EOT
...
EOT
cat <<EOT | $SQLPLUS $USR/$PWD@"(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=$HOST)(PORT=$PORT))(CONNECT_DATA=(SID=$SID)))" > $DIR/RBLLEERUTCOTIZ_PKG_BODY.sql
SET PAGESIZE 999 LINESIZE 999;
SELECT text from all_source where name ='RBLLEERUTCOTIZ_PKG' and type in('PACKAGE BODY') and OWNER='ADMIMED_CONV' order by line asc;
EOT

cat <<EOT | $SQLPLUS $USR/$PWD@"(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=$HOST)(PORT=$PORT))(CONNECT_DATA=(SID=$SID)))" > $DIR/RBLPRESTPAQUETE_PKG.sql
SET PAGESIZE 999 LINESIZE 999;
select text from all_source where name = 'RBLPRESTPAQUETE_PKG' and type in('PACKAGE','SYNONYM') order by line asc;
EOT
...
EOT
cat <<EOT | $SQLPLUS $USR/$PWD@"(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=$HOST)(PORT=$PORT))(CONNECT_DATA=(SID=$SID)))" > $DIR/RBLSOLICFOLIOS_PKG_BODY.sql
SET PAGESIZE 999 LINESIZE 999;
SELECT text from all_source where name ='RBLSOLICFOLIOS_PKG' and type in('PACKAGE BODY') and OWNER='ADMIMED_CONV' order by line asc;
EOT
...
EOT
cat <<EOT | $SQLPLUS $USR/$PWD@"(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=$HOST)(PORT=$PORT))(CONNECT_DATA=(SID=$SID)))" > $DIR/RBLVALORVARI_PKG_BODY.sql
SET PAGESIZE 999 LINESIZE 999;
SELECT text from all_source where name ='RBLVALORVARI_PKG' and type in('PACKAGE BODY') and OWNER='ADMIMED_CONV' order by line asc;
EOT
...
EOT
cat <<EOT | $SQLPLUS $USR/$PWD@"(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=$HOST)(PORT=$PORT))(CONNECT_DATA=(SID=$SID)))" > $DIR/RBLVALTRANS_PKG_BODY.sql
SET PAGESIZE 999 LINESIZE 999;
SELECT text from all_source where name ='RBLVALTRANS_PKG' and type in('PACKAGE BODY') and OWNER='ADMIMED_CONV' order by line asc;
EOT
