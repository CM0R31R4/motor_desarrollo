CREATE OR REPLACE FUNCTION traductor_in_validacat_colmena(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	/*Ejemplo*/
	-- execute isapre..CGCValidaCat 67,[76016305-8],[0004784367-7],[0004784367-7],[0004784367-7],[0004784367-7],[999],[JC],[888888],[01],[01],[1980-06-03],[M],[2013-05-22],[2013-05-30],,[],[],[],[],[],[],[0],[0],[N],[N],[N],[01],[RM],[222222],[1],[],[],[], @extRespuestaCAT OUTPUT, @extMensajeCAT OUTPUT select @extRespuestaCAT as extRespuestaCAT, @extMensajeCAT as extMensajeCAT
...
CREATE OR REPLACE FUNCTION traductor_out_validacat_colmena(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	xml2:=logapp(xml2,'COLMENA: RSP_VALIDACAT -> extRespuestaCat='||cod_resp1||' -extMensajeCat='||mensaje_resp1);
