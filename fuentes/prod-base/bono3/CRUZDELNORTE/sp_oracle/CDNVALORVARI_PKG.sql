...
SQL*Plus: Release 11.2.0.3.0 Production on Wed Jun 17 15:56:01 2015
...
FUNCTION VALORPRESTACION2 RETURNS NUMBER
 Argument Name			Type			In/Out Default?
 ------------------------------ ----------------------- ------ --------
 PRUTPRES			NUMBER			IN
 PCODARA			NUMBER			IN
 PURGENCIA			VARCHAR2		IN
 PFUERAHORA			VARCHAR2		IN
FUNCTION VALORPRESTACION3 RETURNS NUMBER
 Argument Name			Type			In/Out Default?
 ------------------------------ ----------------------- ------ --------
 PRUTPRES			NUMBER			IN
 PCODARA			NUMBER			IN
...
package CDNVALORVARI_PKG is
 ...
 FUNCTION valorPrestacion2(pRutPres   number,
			   pCodAra    number,
			   pUrgencia  varchar2,
			   pFueraHora varchar2) RETURN number;

 FUNCTION valorPrestacion3(pRutPres   number,
			   pCodAra    number,
			   pUrgencia  varchar2,
			   pFueraHora varchar2) RETURN number;
