...
<SOAP-ENV:Body>
   <ns1:wmImed_SrvConfirmacionResponse>
	<ns1:wmImed_SrvConfirmacionResult>
	&lt;?xml version="1.0" encoding="UTF-8"?& gt;
	&lt;MsgOutput&gt;
		&lt;CodRetorno&gt;1&lt;/CodRetorno&gt;
		&lt;MsgError&gt;0&lt;/MsgError&gt;
		&lt;MsgText&gt;&lt;/MsgText&gt;
		&lt;extFolioAuto&gt;0000087861&lt;/extFolioAuto&gt;
...
begin
	...
	xml2:=put_campo(xml2,'RESPONSE_CIA',get_campo('RESPUESTA_CIA',xml2));

	--Viene en este formato con &gt;&lt
	respuesta1:=replace(replace(get_campo('RESPUESTA_CIA',xml2),'&gt;','>'),'&lt;','<');
	xml2:=logapp(xml2,'Respuesta_Generica='||respuesta1);
