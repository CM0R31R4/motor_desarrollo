...
begin
	...
	xml2:=put_campo(xml2,'__SECUENCIAOK__','0');
        ...
        xml2:=put_campo(xml2,'SQLINPUT',declare_params||' EXEC dbo.SMDValTrans '||ext_cod_financiador||','||ext_folio_financiador||',"'||ext_accion||'","'||ext_pregunta||'",'||output_params);
        return xml2;
end;
$$
LANGUAGE plpgsql;
...
begin
	...
	xml2:=logapp(xml2,'FERROSALUD: RSP_VALTRANS -> extRespuesta1='||respuesta1||' -extCodResp1='||cod_resp1||' -extMensajeResp1='||mensaje_resp1);
