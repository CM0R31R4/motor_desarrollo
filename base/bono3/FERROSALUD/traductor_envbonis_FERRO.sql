CREATE OR REPLACE FUNCTION traductor_in_envbonis_ferrosalud(varchar)
returns varchar as
...
begin
	...
	xml2    :=put_campo(xml2,'_SECUENCIA_','0');
        ...
        ext_hom_numero_convenio :=get_campo('EXTHOMNUMEROCONVENIO',xml2);
...
CREATE OR REPLACE FUNCTION traductor_out_envbonis_ferrosalud(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	--Parseo la Respuesta
       ...
       xml2:=logapp(xml2,'FERROSALUD: RSP_ENVBONIS -> extCodResp1='||cod_resp1||' -extMensajeResp1='||mensaje_resp1);
