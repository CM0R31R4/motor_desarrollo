...
begin
	...
	--Valida formato del Rut
        ...
        if (rut_cotiz1='') or (rut_ben1='') then
        ...
        xml2:=put_campo(xml2,'SQLINPUT',declare_params ||' EXEC dbo.SMDBenRec '|| cod_fin1 ||',"'||rut_cotiz1||'",'||corr_benef1||',"'||rut_ben1||'",'||output_params);
        return xml2;
end;
$$
LANGUAGE plpgsql;
...
begin
	...
	xml2:=logapp(xml2,'FERROSALUD: RSP_BENREC -> extCodResp1='||cod_resp1||' -extMensajeResp1='||mensaje_resp1);
