CREATE OR REPLACE FUNCTION traductor_in_solicfolios_ferrosalud(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
CREATE OR REPLACE FUNCTION traductor_out_solicfolios_ferrosalud(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	xml2:=logapp(xml2,'FERROSALUD: RSP_SOLICFOLIOS -> extCodResp1='||cod_resp1||' -extMensajeResp1='||mensaje_resp1||' -extFoliosResp1='||folios_resp1);
