...
begin
	...
	--Valida formato del Rut
        ...
        xml2:=put_campo(xml2,'SQLINPUT',declare_params||' EXEC dbo.SMDEnrola '||cod_fin1||',"'||rut_enrola1||'","'||rut_ben1||'",'||out_params);
...
begin
	...
	xml2:=logapp(xml2,'FERROSALUD: RSP_ENROLA -> extCodResp1='||cod_resp1||' -extNombre1='||nombre1);
