...
begin
	...
	xml2:=logapp(xml2,'CRUZBLANCA: RSP_PRESTPAQUETE -> extCodResp1='||cod_resp1||' -extMensajeResp1='||mensaje_resp1||' -extCodHomo1='||cod_homo1||' -extItemHomo1='||item_homo1||' -extCantidad1='||cantidad1);
