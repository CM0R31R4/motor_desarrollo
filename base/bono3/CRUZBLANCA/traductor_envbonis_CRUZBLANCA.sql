CREATE OR REPLACE FUNCTION traductor_in_envbonis_cruzblanca(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	xml2:=logapp(xml2,'MUESTRA_SQLINPUT ='||get_campo('SQLINPUT',xml2));
...
CREATE OR REPLACE FUNCTION traductor_out_envbonis_cruzblanca(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	xml2:=logapp(xml2,'CRUZBLANCA: RSP_ENVBONIS -> extCodResp1='||cod_resp1||' -extMensajeResp1='||mensaje_resp1);
