CREATE OR REPLACE FUNCTION bono3.traductor_in_valorvari_cruzblanca(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	cod_fin1        :=get_campo('EXTCODFINANCIADOR',xml2);
        ...
        lista7          :=coalesce(nullif(get_campo('EXTLISTA7',xml2),''),'0');         -- char(255),
	...
	-- especialidad1 tratamiento1 cod_diag1 
	--DECLARE @extGlosa5       char(50) execute prestacion..INGValorVari 78,[00000049945-000],[82637],[130600],[76398000-6],[-0],[], [8345735-K],[5804735-K],[],[],0,[N],"0301045000|  |0301045000     |N|01|000000000000|","","","","","","",1,
...
CREATE OR REPLACE FUNCTION bono3.traductor_out_valorvari_cruzblanca(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
