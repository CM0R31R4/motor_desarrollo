CREATE OR REPLACE FUNCTION bono3.traductor_in_benrec_cruzblanca(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	cod_fin1        :=trim(get_campo('EXTCODFINANCIADOR',xml2));
        ...
        corr_benef1     :=coalesce(nullif(get_campo('EXTCORRBENEF',xml2),''),'0');      -- No puede ser mayor a 99
...
CREATE OR REPLACE FUNCTION bono3.traductor_out_benrec_cruzblanca(varchar)
returns varchar as
$$
declare
        xml1		alias for $1;
