...
/*
   ...
   Parametros I
       ...
       @extHomNumeroConvenio  : Homólogo numero de convenio
...
1))
 ...
 --// Determinación de los convenios preferenci
...
ar(26),getdate(),109)
 ...
 --// Decodificación de las listas de prestaciones.
...
Select EsvCodEsp_id
     ...
     if @@rowcount != 1
      begin
       Select @ValorDesde = 0, @ValorHasta = 0, @ValorNomina = 0, @Modalidad = '',
              @ErrorCo
de = 101001 --// Más de una Especialidad para esta prestacion - convenio
      end
...
g = 52
    ...
    if @CodEsp is not null and @CodEsp <> 'XXX'
     begin --// INICIO
       if @ItemReal > 0 and @ItemReal < 99 --//Este Item Debiera Ser un Pabellón.
        begin
         -- // Obtención de la Nómina genérica del convenio. REGLA DE N
EGOCIO.
...
obGruCob_id    Output,
   ...
   insert Tiempos values("P59",@Ini2,@Fin)
    ...
    begin --// Dado que hay un Plan Alternativo, Se Buscará el primero q
ue
