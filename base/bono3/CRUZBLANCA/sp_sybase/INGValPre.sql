...
: Mensaje de Error. 
 ...
 Descripcion 
   ...
   Este Servicio que envia datos de todas las lÝneas de prestaci
ones 
...
restacionValorizada
      set Resultado = 1
         ,Error = 400806
         ,Glosa1 = 'Prest mßs de 1 vez en la venta'
...
acionPaquete
         set Resultado = 1
            ,Error  = 400378
            ,Glosa1 = 'Pqte en mßs de 1 espec/no conv.'
         where Indice = @MinValor 
         /*
          Select @extCodError = 'N' 
          Select @extMensajeError = 'Pqte en m
ßs de 1 espec/no conv.' --TRX DENEGADA (EI:400378) 
          return 1 
          */
      end 
   end 
