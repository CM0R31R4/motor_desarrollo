CREATE OR REPLACE FUNCTION traductor_in_valorvari_chuqui(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
CREATE OR REPLACE FUNCTION traductor_out_valorvari_chuqui(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	xml2    :=put_campo(xml2,'ESTADO_TX','TERMINADO_OK');
		...
		if aux1 is not null then
                        ...
                        xml2:=put_campo(xml2,'ERRORCOD','99');
			xml2:=put_campo(xml2,'ERRORMSG','Chuqui:Error_ValorVari');
                end if;
                xml2    :=put_campo(xml2,'CODIGO_RESP','2');
