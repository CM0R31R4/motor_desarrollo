...
begin
	...
	xml2:=logapp(xml2,'RIOBLANCO: RSP_LEERUTCOTIZ -> extNombreCotiz1='||nombre_cotiz1||' -extCodResp1='||cod_resp1||' -extMensajeResp1='||mensaje_resp1||' -extCorrBenef1='||corr_benef1||' -extRutBenef1='||rut_benef1||' -extApellPat1='||apell_pat1||' -extApellMat1='||apell_mat1||' -extNombres1='||nombres1||' -extCodEstBenef1='||cod_est_benef1||' -extDescEstado1='||desc_estado1);
