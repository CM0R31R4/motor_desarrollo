CREATE OR REPLACE FUNCTION traductor_in_bencertif_consalud(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
CREATE OR REPLACE FUNCTION traductor_out_bencertif_consalud(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
