...
begin
	...
	--Rut con formato
        ...
        xml2:=put_campo(xml2,'INPUT','["IMEDSOF.CONLEERUTCOTIZ_PKG.CONLEERUTCOTIZ", [ "$o$STRING", '||extCodFinanciador||', '||chr(34)||rut_cotiza1||chr(34)||',"$o$STRING", "$o$STRING", "$o$STRING", "$o$NUMBER[10]", "$o$STRING[10]","$o$STRING[10]", "$o$STRING[10]", "$o$STRING[10]", "$o$STRING[10]", "$o$STRING[10]"]]'||chr(10)||chr(10));
