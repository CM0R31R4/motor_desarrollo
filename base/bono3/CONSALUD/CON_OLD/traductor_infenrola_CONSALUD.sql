...
begin
	...
	if length(rut_acomp1)>'0' then rut_acomp1       :=lpad(rut_acomp1,10,'0')||'-'||motor_modulo11(rut_acomp1);end if;
        ...
        xml2:=put_campo(xml2,'INPUT','["IMEDSOF.CONINFENROLA_PKG.CONINFENROLA", [ "$o$STRING", '||extCodFinanciador||', '||chr(34)||rut_benef1||chr(34)||', '||chr(34)||rut_acomp1||chr(34)||', '||chr(34)||extIndEnrola||chr(34)||', "$o$STRING", "$o$STRING" ]]'||chr(10)||chr(10));
