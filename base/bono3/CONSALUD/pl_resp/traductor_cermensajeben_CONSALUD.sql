CREATE OR REPLACE FUNCTION bono3.traductor_in_cermensajeben_consalud(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
CREATE OR REPLACE FUNCTION bono3.traductor_out_cermensajeben_consalud(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
