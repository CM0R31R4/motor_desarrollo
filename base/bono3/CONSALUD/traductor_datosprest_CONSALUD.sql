...
begin
	...
	xml2:=logapp(xml2,'CONSALUD: RSP_DATOSPREST -> extEstConv1='||est_conv1||' -extNivel1='||nivel1||' -extTipoPrest1='||tipo_prest1||' -extCodEspec1='||cod_espec1||' -extCodProf1='||cod_prof1||' -extAntiguedad1='||antiguedad1);
