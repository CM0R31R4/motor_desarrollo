...
SQL> SQL> PROCEDURE BANVALORIZI
 ...
 COL_EXTTIPOBONIF1		TABLE OF NUMBER(1)	OUT
 COL_EXTCOPAGO1 		TABLE OF NUMBER(12)	OUT
 COL_EXTTIPOBONIF2		TABLE OF NUMBER(1)	OUT
 COL_EXTCOPAGO2 		TABLE OF NUMBER(12)	OUT
 COL_EXTTIPOBONIF3		TABLE OF NUMBER(1)	OUT
 COL_EXTCOPAGO3 		TABLE OF NUMBER(12)	OUT
 COL_EXTTIPOBONIF4		TABLE OF NUMBER(1)	OUT
 COL_EXTCOPAGO4 		TABLE OF NUMBER(12)	OUT
 COL_EXTTIPOBONIF5		TABLE OF NUMBER(1)	OUT
 COL_EXTCOPAGO5 		TABLE OF NUMBER(12)	OUT

SQL> 
TEXT
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
PACKAGE 	   Banvalorizi_Pkg IS
