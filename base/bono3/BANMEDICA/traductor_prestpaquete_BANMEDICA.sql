...
begin
	...
	xml2:=logapp(xml2,'BANMEDICA: RSP_PRESTPAQUETE -> extCodResp1='||cod_resp1||' -extMensajeResp1='||mensaje_resp1||' -extCodHomol1='||cod_homol1||' -extItemHomol1='||item_homol1||' -extCantidad1='||cantidad1);
