CREATE OR REPLACE FUNCTION traductor_in_valorvari_cchc(varchar)
returns varchar as
$$
declare
...
begin
	...
	raise notice 'JCC_rut_conv1=% rut_tratante1=% rut_solic1=% rut_benef1=% ',rut_conv1,rut_tratante1,rut_solic1,rut_benef1;
...
CREATE OR REPLACE FUNCTION traductor_out_valorvari_cchc(varchar)
returns varchar as
$$
declare
	xml1  	alias for $1;
...
begin
	...
	--raise notice 'JCC_VALORVARI_Receive EXTCODERROR =%-EXTMENSAJEERROR =% - i=% j=%',cod_resp1,mensaje_resp1,i,j;
	...
	xml2:=logapp(xml2,'CCHC: RSP_VALORVARI -> extCodResp1='||cod_resp1||' -extMensajeResp1='||mensaje_resp1||' -extPlanResp1='||plan_resp1||' -extGlosa1='||glosa1||' -extGlosa2='||glosa2||' -extGlosa3='||glosa3||' -extGlosa4='||glosa4||' -extGlosa5='||glosa5||' -extValorPrest1='||valor_prest1||' -extAporteFin1='||aporte_fin1||' -extCopago1='||copago1||' -extInternoIsa1='||interno_isa1||' -extTipoBonif1='||tipo_bonif1||' -extCopago1='||ext_copago1);
