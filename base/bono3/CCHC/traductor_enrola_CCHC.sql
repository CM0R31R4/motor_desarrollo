CREATE OR REPLACE FUNCTION traductor_in_enrola_cchc(varchar)
returns varchar as
$$
declare
        xml1    	alias for $1;
...
CREATE OR REPLACE FUNCTION traductor_out_enrola_cchc(varchar)
returns varchar as
$$
declare
        xml1            alias for $1;
...
begin
	...
	xml2:=logapp(xml2,'CCHC: RSP_ENROLA -> extCodResp1='||cod_resp1||' -extMensajeResp1='||mensaje_resp1);	
