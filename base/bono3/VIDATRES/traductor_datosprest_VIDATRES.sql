...
begin
	...
	xml2:=logapp(xml2,'VIDATRES: RSP_DATOSPREST -> extCodError='||est_conv1||' -extMensajeError='||nivel1||' -extTipoPrest1='||tipo_prest1||' -extCodEspec1='||cod_espec1||' -extCodProf1='||cod_prof1||' -extAntiguedad1='||antiguedad1);
