CREATE OR REPLACE FUNCTION bono3.traductor_in_solicfolios_vidatres(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	xml2:=put_campo(xml2,'INPUT','["INFOMEDICA.VIDSOLICFOLIOS_PKG.VIDSOLICFOLIOS", ["$o$STRING", '||extCodFinanciador||', '||extNumFolios||', "$o$STRING", "$o$STRING", "$o$NUMBER[10]"]]'||chr(10)||chr(10));
...
CREATE OR REPLACE FUNCTION bono3.traductor_out_solicfolios_vidatres(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
