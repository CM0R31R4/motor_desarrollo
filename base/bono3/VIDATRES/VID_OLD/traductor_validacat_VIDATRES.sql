CREATE OR REPLACE FUNCTION bono3.traductor_in_validacat_vidatres(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	if length(rut_conv1)>'0' then rut_conv1         :=lpad(rut_conv1,10,'0')||'-'||motor_modulo11(rut_conv1);end if;
        ...
        xml2:=put_campo(xml2,'INPUT','["INFOMEDICA.VIDVALIDACAT_PKG.VIDVALIDACAT", [ "$o$STRING", '||extCodFinanciador||', '||chr(34)||rut_conv1||chr(34)||', '||chr(34)||rut_tratante1||chr(34)||', '||chr(34)||rut_solic1||chr(34)||', '||chr(34)||rut_benef1||chr(34)||', '||chr(34)||rut_cotiza1||chr(34)||', '||chr(34)||extCodigoHomologo||chr(34)||', '||chr(34)||extItem||chr(34)||', '||chr(34)||extCodigoDiagnostico||chr(34)||', '||chr(34)||extCodModalidad||chr(34)||', '||chr(34)||extCodTipAtencion||chr(34)||', '||chr(34)||extFechaNacimiento||chr(34)||', '||chr(34)||extCodSexo||chr(34)||', '||chr(34)||extFechaInicio||chr(34)||', '||chr(34)||extFechaTermino||chr(34)||', '||extFrecPrestDia||', '||chr(34)||extListaPrestacA||chr(34)||', '||chr(34)||extListaPrestacB||chr(34)||', '||chr(34)||extListaPrestacC||chr(34)||', '||chr(34)||extListaPrestacD||chr(34)||', '||chr(34)||ExtListaPrestacE||chr(34)||', '||chr(34)||extListaPrestacF||chr(34)||', '||chr(34)||extIndVideo||chr(34)||', '||chr(34)||extIndBilateral||chr(34)||', '||chr(34)||extRecargoFueraHora||chr(34)||', '||chr(34)||extIndReembolso||chr(34)||', '||chr(34)||extIndPrograma||chr(34)||', '||chr(34)||extCodAplicacion||chr(34)||', '||chr(34)||extCodRegion||chr(34)||', '||chr(34)||extCodSucur||chr(34)||', '||chr(34)||extTipoPrestador||chr(34)||', '||chr(34)||extCodEspecialidades||chr(34)||', '||chr(34)||extCodProfesiones||chr(34)||', '||chr(34)||extAnosAntiguedad||chr(34)||', "$o$STRING", "$o$STRING" ]]'||chr(10)||chr(10));
...
CREATE OR REPLACE FUNCTION bono3.traductor_out_validacat_vidatres(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
