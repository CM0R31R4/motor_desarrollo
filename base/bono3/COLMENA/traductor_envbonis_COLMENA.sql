CREATE OR REPLACE FUNCTION traductor_in_envbonis_colmena(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	cod_fin1        :=get_campo('EXTCODFINANCIADOR',xml2);
        ...
        --nom_prest1      :=substring(get_campo('EXTNOMPRESTADOR',xml2),1,28);      -- char(40),
...
CREATE OR REPLACE FUNCTION traductor_out_envbonis_colmena(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	xml2:=logapp(xml2,'COLMENA: RSP_ENVBONIS -> extCodResp1='||cod_resp1||' -extMensajeResp1='||mensaje_resp1);	
