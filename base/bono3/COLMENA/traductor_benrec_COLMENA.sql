CREATE OR REPLACE FUNCTION traductor_in_benrec_colmena(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	exec_sp:= 'execute isapre..CGCBenRec '||cod_fin1||',"'||rut_cotiza1||'",'||corr_benef1||',"'||rut_ben1||'", @extCodResBen OUTPUT, @extMensajeError OUTPUT ';
	/*Ejemplo del SP de Sybase*/
	--exec isapre..CGCBenRec 78, '0005308213-0', 2, '0000000001-9', @extCodResBen output, @extMensajeError output
...
CREATE OR REPLACE FUNCTION traductor_out_benrec_colmena(varchar)
returns varchar as
$$
declare
        xml1		alias for $1;
...
begin
	...
	xml2:=logapp(xml2,'COLMENA: RSP_BENREC -> extCodResp1='||cod_resp1||' -extMensajeResp1='||mensaje_resp1);
