...
--Posgres.Bono3
insert into parametros_procesos (id_fin,nom_fin,fin_modulo_api,fin_puerto_local_api,fin_hilos_api,fin_prefijo_api,fin_base_datos,fin_ip_conexion_bd,fin_usuario_bd,fin_clave_bd,pxml_modulo,pxml_puerto_bd,pxml_prefijo_log,pxml_timeoutbd,lstr_modulo,lstr_puerto_db,lstr_prefijo_log,lstr_timeout_leedata) values  (100,'MOTOR','Api_PG','9000',5,'API','dmotor','127.0.0.1','isys','pwd','PXML','9000','XML',10,'LSTR',9000,'LST',20);

-- DEC
insert into parametros_procesos (id_fin,nom_fin,fin_modulo_api,fin_puerto_local_api,fin_hilos_api,fin_prefijo_api,fin_base_datos,fin_ip_conexion_bd,fin_usuario_bd,fin_clave_bd,pxml_modulo,pxml_puerto_bd,pxml_prefijo_log,pxml_timeoutbd,lstr_modulo,lstr_puerto_db,lstr_prefijo_log,lstr_timeout_leedata) values (3,'MOTOR_DEC','Api_PG_DEC','9003',5,'API_DEC','motor','10.100.32.58','usr','pwd','PXML','9000','XML',10,'LSTR',9000,'LST',20);
...
--Cchc.Bono3
insert into parametros_procesos (id_fin,nom_fin,fin_modulo_api,fin_puerto_local_api,fin_hilos_api,fin_prefijo_api,fin_base_datos,fin_ip_conexion_bd,fin_usuario_bd,fin_clave_bd,pxml_modulo,pxml_puerto_bd,pxml_prefijo_log,pxml_timeoutbd,lstr_modulo,lstr_puerto_db,lstr_prefijo_log,lstr_timeout_leedata) values  (11,'CCHC','API_CCHC_BNO','8211',2,'API','sermed','10.150.73.174:1433','imed','servicio','CCHC_PXML_BNO','9000','XML',10,'CCHC_LSTR_BNO',9000,'LST',20);
--VidaCamara.Bono3
insert into parametros_procesos (id_fin,nom_fin,fin_modulo_api,fin_puerto_local_api,fin_hilos_api,fin_prefijo_api,fin_base_datos,fin_ip_conexion_bd,fin_usuario_bd,fin_clave_bd,pxml_modulo,pxml_puerto_bd,pxml_prefijo_log,pxml_timeoutbd,lstr_modulo,lstr_puerto_db,lstr_prefijo_log,lstr_timeout_leedata) values  (44,'VIDACAMARA','API_VIDACAMARA_BNO','8244',2,'API','vcamara','10.150.73.174:1433','imedvc','serviciovc','VIDACAMARA_PXML_BNO','9000','XML',10,'VIDACAMARA_LSTR_BNO',9000,'LST',20);
--Colmena.Bono3
