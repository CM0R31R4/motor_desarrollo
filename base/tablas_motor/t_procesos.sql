...
--GrabaXmlDEC
insert into procesos values ('PXML_DEC','127.0.0.1',5,7000);
...
-- MultiCaja.
insert into procesos values ('PXML_MC','127.0.0.1',10,9050);

-- WsLogsMotor.
insert into procesos values ('PXML_LOGS_MOTOR','127.0.0.1',10,9060);
...
insert into procesos values ('FONASA_PXML_BNO','127.0.0.1',10,8101);
...
--DESA.BONO3 SANLORENZO
insert into procesos values ('SANLORENZO_LSTR_BNO','127.0.0.1',20,8062);
insert into procesos values ('SANLORENZO_PXML_BNO','127.0.0.1',10,8162);
--insert into procesos values ('API_SANLORENZO_BNO','127.0.0.1',10,8262);

--DESA.BONO3 FUSAT
insert into procesos values ('FUSAT_LSTR_BNO','127.0.0.1',20,8063);
insert into procesos values ('FUSAT_PXML_BNO','127.0.0.1',10,8163);
--insert into procesos values ('API_FUSAT_BNO','127.0.0.1',10,8634);

--DESA.BONO3 CHUQUICAMATA
insert into procesos values ('CHUQUICAMATA_LSTR_BNO','127.0.0.1',20,8065);
insert into procesos values ('CHUQUICAMATA_PXML_BNO','127.0.0.1',10,8165);
--insert into procesos values ('API_CHUQUICAMATA_BNO','127.0.0.1',10,8265);
...
--DESA.BONO3 RIOBLANCO
insert into procesos values ('RIOBLANCO_LSTR_BNO','127.0.0.1',20,8068);
insert into procesos values ('RIOBLANCO_PXML_BNO','127.0.0.1',10,8168);
--insert into procesos values ('API_RIOBLANCO_BNO','127.0.0.1',10,8268);
...
insert into procesos values ('VIDATRES_PXML_BNO','127.0.0.1',10,8180);
--insert into procesos values ('API_VIDATRES_BNO','127.0.0.1',10,8280);

--DESA.BONO3 FERROSALUD
