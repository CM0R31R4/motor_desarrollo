...
CREATE TABLE isys_tx_formatos (
    ...
    tipo_llave character varying(10),	--XML
    llave character varying(200),	--</requerimiento>
    data_web smallint,
