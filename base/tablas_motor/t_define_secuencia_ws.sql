...
/********** AUTENTIA MEDIOS_PAGOS - FINANCIADOR=2(MULTI CAJA) **********/
--insert into define_secuencia_ws values ('TRX_VERIDERECHO',2,100,'proc_parser_in_verder_mp','proc_parser_out_verder_mp','AUT_MC');
--insert into define_secuencia_ws values ('TRX_VERIDERFAST',2,100,'proc_parser_in_verderfast_mp','proc_parser_out_verderfast_mp','AUT_MC');
...
--insert into define_secuencia_ws values ('TRX_CONS_CONVENIO',2,100,'proc_parser_in_cons_convenio_mp','proc_parser_out_cons_convenio_mp','AUT_MC');

--insert into define_secuencia_ws values ('TRX_VERIDERECHO',2,20,'proc_parser_in_verder_mp','proc_parser_out_verder_mp','AUT_MC');
--insert into define_secuencia_ws values ('TRX_VERIDERFAST',2,20,'proc_parser_in_verderfast_mp','proc_parser_out_verderfast_mp','AUT_MC');
--insert into define_secuencia_ws values ('TRX_VENTA',2,20,'proc_parser_in_venta_mp','proc_parser_out_venta_mp','AUT_MC');
--insert into define_secuencia_ws values ('TRX_ANULA',2,20,'proc_parser_in_anula_mp','proc_parser_out_anula_mp','AUT_MC');
--insert into define_secuencia_ws values ('TRX_REIMPRESION',2,20,'proc_parser_in_reimpresion_mp','proc_parser_out_reimpresion_mp','AUT_MC');
--insert into define_secuencia_ws values ('TRX_CONS_CONVENIO',2,20,'proc_parser_in_cons_convenio_mp','proc_parser_out_cons_convenio_mp','AUT_MC');

insert into define_secuencia_ws values ('imedverder',2,20,'proc_parser_in_verder_mp','proc_parser_out_verder_mp','MultiCaja');
insert into define_secuencia_ws values ('imedfast',2,20,'proc_parser_in_verderfast_mp','proc_parser_out_verderfast_mp','MultiCaja');
insert into define_secuencia_ws values ('imedventa',2,20,'proc_parser_in_venta_mp','proc_parser_out_venta_mp','MultiCaja');
insert into define_secuencia_ws values ('imedanula',2,20,'proc_parser_in_anula_mp','proc_parser_out_anula_mp','MultiCaja');
insert into define_secuencia_ws values ('imedreimpresion',2,20,'proc_parser_in_reimpresion_mp','proc_parser_out_reimpresion_mp','MultiCaja');
insert into define_secuencia_ws values ('imedconsultaconvenio',2,20,'proc_parser_in_cons_convenio_mp','proc_parser_out_cons_convenio_mp','MultiCaja');


-- *** Inicio Secuencias de Log Motor. ***
--insert into define_secuencia_ws values ('loganulabonou',3,20,'traductor_in_loganulabonu','traductor_out_loganulabonu','LogsMotor');
insert into define_secuencia_ws values ('loganulabonou',3,20,'traductor_in_loganulabonou','','LogsMotor');
-- *** Fin Secuencias de Log Motor. ***

/********** CUENTAS MEDICAS **********/
/*Flujo 3005*/
insert into define_secuencia_ws values ('iniciotx',88,550,'iniciotx_ctamed','','CTAMED');
--insert into define_secuencia_ws values ('iniciotx',88,500,'iniciotx_ctamed','','CTAMED');
--insert into define_secuencia_ws values ('fintx',88,30,'fintx_ctamed','','CTAMED');
insert into define_secuencia_ws values ('fintx',88,88,'traductor_in_cerconciliacioncme_masvida','traductor_out_cerconciliacioncme_masvida','MASVIDA');
--insert into define_secuencia_ws values ('anulatx',88,30,'anulatx_ctamed','','CTAMED');

--CUENTA MEDICA
insert into define_secuencia_ws values ('cerenvcta',88,88,'traductor_in_cerenvcta_masvida','traductor_out_cerenvcta_masvida','MAS_VIDA');
insert into define_secuencia_ws values ('cerenvdetequipo',88,88,'traductor_in_cerenvdetequipo_masvida','traductor_out_cerenvcta_masvida','MAS_VIDA');
insert into define_secuencia_ws values ('cerenvdetinsumo',88,88,'traductor_in_cerenvdetinsumo_masvida','traductor_out_cerenvcta_masvida','MAS_VIDA');
insert into define_secuencia_ws values ('cerenvdethotele',88,88,'traductor_in_cerenvdethotele_masvida','traductor_out_cerenvcta_masvida','MAS_VIDA');
insert into define_secuencia_ws values ('cerenvinfpac',88,88,'traductor_in_cerenvinfpac_masvida','traductor_out_cerenvcta_masvida','MAS_VIDA');
insert into define_secuencia_ws values ('cerenvpaquete',88,88,'traductor_in_cerenvpaquete_masvida','traductor_out_cerenvcta_masvida','MAS_VIDA');
insert into define_secuencia_ws values ('cerenvtipant',88,88,'traductor_in_cerenvtipant_masvida','traductor_out_cerenvcta_masvida','MAS_VIDA');
insert into define_secuencia_ws values ('cerrelhmqprot',88,88,'traductor_in_cerrelhmqprot_masvida','traductor_out_cerenvcta_masvida','MAS_VIDA');

/*Servicios Inactivos
insert into define_secuencia_ws values ('ceremibonopam',88,30,'traductor_in_ceremibonopam_masvida','traductor_out_ceremibonopam_masvida','MAS_VIDA');
insert into define_secuencia_ws values ('cerobtbonequipo',88,30,'traductor_in_cerobtbonequipo_masvida','traductor_out_cerobtbonequipo_masvida','MAS_VIDA');
insert into define_secuencia_ws values ('cerobtbonhotele',88,30,'traductor_in_cerobtbonhotele_masvida','traductor_out_cerobtbonhotele_masvida','MAS_VIDA');
insert into define_secuencia_ws values ('cerobtboninsumo',88,30,'traductor_in_cerobtboninsumo_masvida','traductor_out_cerobtboninsumo_masvida','MAS_VIDA');
insert into define_secuencia_ws values ('cerobtbonospam',88,30,'traductor_in_cerobtbonospam_masvida','traductor_out_cerobtbonospam_masvida','MAS_VIDA');
insert into define_secuencia_ws values ('cerobtfecpag',88,30,'traductor_in_cerobtfecpag_masvida','traductor_out_cerobtfecpag_masvida','MAS_VIDA');
insert into define_secuencia_ws values ('cerobtpaquete',88,30,'traductor_in_cerobtpaquete_masvida','traductor_out_cerobtpaquete_masvida','MAS_VIDA');
insert into define_secuencia_ws values ('cerobtsaldospag',88,30,'traductor_in_cerobtsaldospag_masvida','traductor_out_cerobtsaldospag_masvida','MAS_VIDA');
*/
...
--insert into define_secuencia_ws values ('bencertif', 15, 101,'traductorWL_in_bencertif_fonasa', 'traductorWL_out_bencertif_fonasa', 'FONASA');
--insert into define_secuencia_ws values ('bencertif', 1, 101,'traductorWL_in_bencertif_fonasa', 'traductorWL_out_bencertif_fonasa', 'FONASA');
...
--insert into define_secuencia_ws values ('anulabonou', 15, 101,'traductorWL_in_anulabonou_fonasa', 'traductorWL_out_anulabonou_fonasa', 'FONASA');
--insert into define_secuencia_ws values ('anulabonou', 1, 101,'traductorWL_in_anulabonou_fonasa', 'traductorWL_out_anulabonou_fonasa', 'FONASA');
...
--insert into define_secuencia_ws values ('coptran', 15, 101,'traductorWL_in_coptran_fonasa', 'traductorWL_out_coptran_fonasa', 'FONASA');
--insert into define_secuencia_ws values ('envbono', 15, 101,'traductorWL_in_envbono_fonasa', 'traductorWL_out_envbono_fonasa', 'FONASA');
--insert into define_secuencia_ws values ('coptran', 1, 101,'traductorWL_in_coptran_fonasa', 'traductorWL_out_coptran_fonasa', 'FONASA');
--insert into define_secuencia_ws values ('envbono', 1, 101,'traductorWL_in_envbono_fonasa', 'traductorWL_out_envbono_fonasa', 'FONASA');
...
--insert into define_secuencia_ws values ('datosprest', 15, 101,'traductorWL_in_datosprest_fonasa', 'traductorWL_out_datosprest_fonasa', 'FONASA');
--insert into define_secuencia_ws values ('datosprest', 1, 101,'traductorWL_in_datosprest_fonasa', 'traductorWL_out_datosprest_fonasa', 'FONASA');
...
--insert into define_secuencia_ws values ('enrola', 15, 101,'traductorWL_in_enrola_fonasa', 'traductorWL_out_enrola_fonasa', 'FONASA');
--insert into define_secuencia_ws values ('enrola', 1, 101,'traductorWL_in_enrola_fonasa', 'traductorWL_out_enrola_fonasa', 'FONASA');
...
--insert into define_secuencia_ws values ('solicfolios', 15, 101,'traductorWL_in_solicfolios_fonasa', 'traductorWL_out_solicfolios_fonasa', 'FONASA');
--insert into define_secuencia_ws values ('solicfolios', 1, 101,'traductorWL_in_solicfolios_fonasa', 'traductorWL_out_solicfolios_fonasa', 'FONASA');
...
--insert into define_secuencia_ws values ('validacat', 15, 101,'traductorWL_in_validacat_fonasa', 'traductorWL_out_validacat_fonasa', 'FONASA');
--insert into define_secuencia_ws values ('validacat', 1, 101,'traductorWL_in_validacat_fonasa', 'traductorWL_out_validacat_fonasa', 'FONASA');
...
--insert into define_secuencia_ws values ('valtrans', 15, 101,'traductorWL_in_valtrans_fonasa', 'traductorWL_out_valtrans_fonasa', 'FONASA');
--insert into define_secuencia_ws values ('valtrans', 1, 101,'traductorWL_in_valtrans_fonasa', 'traductorWL_out_valtrans_fonasa', 'FONASA');
...
--insert into define_secuencia_ws values ('cermensajeben', 62, 900,'traductor_in_valtrans_sanlorenzo', 'traductor_out_valtrans_sanlorenzo', 'SAN_LORENZO', '127.0.0.1', 'seq_puerto_fusat');
...
--INSERT INTO define_secuencia_ws VALUES ('envbono_real', 15, 101, 'traductorWL_in_envbono_fonasa', 'traductorWL_out_envbono_fonasa', 'FONASA', NULL, NULL);
--INSERT INTO define_secuencia_ws VALUES ('envbono_real', 1, 101, 'traductorWL_in_envbono_fonasa', 'traductorWL_out_envbono_fonasa', 'FONASA', NULL, NULL);
...
INSERT INTO define_secuencia_ws VALUES ('envbonis_real', 62, 900, 'traductor_in_envbonis_sanlorenzo', 'traductor_out_envbonis_sanlorenzo', 'SAN_LORENZO', '127.0.0.1', 'seq_puerto_fusat');
INSERT INTO define_secuencia_ws VALUES ('envbonis_real', 63, 900, 'traductor_in_envbonis_fusat', 'traductor_out_envbonis_fusat', 'FUSAT', '127.0.0.1', 'seq_puerto_fusat');
INSERT INTO define_secuencia_ws VALUES ('envbonis_real', 65, 900, 'traductor_in_envbonis_chuqui', 'traductor_out_envbonis_chuqui', 'CHUQUICAMATA', '127.0.0.1', 'seq_puerto_fusat');
...
INSERT INTO define_secuencia_ws VALUES ('envbonis_real', 68, 900, 'traductor_in_envbonis_rioblanco', 'traductor_out_envbonis_rioblanco', 'RIO_BLANCO', '127.0.0.1', 'seq_puerto_fusat');
INSERT INTO define_secuencia_ws VALUES ('envbonis_real', 71, 900, 'traductor_in_envbonis_consalud', 'traductor_out_envbonis_consalud', 'CONSALUD', '127.0.0.1', 'seq_puerto_consalud');
INSERT INTO define_secuencia_ws VALUES ('envbonis_real', 76, 900, 'traductor_in_envbonis_fundacion', 'traductor_out_envbonis_fundacion', 'FUNDACION', '127.0.0.1', 'seq_puerto_fundacion');
...
INSERT INTO define_secuencia_ws VALUES ('envbonis_real', 80, 900, 'traductor_in_envbonis_vidatres', 'traductor_out_envbonis_vidatres', 'VIDA_TRES', '127.0.0.1', 'seq_puerto_banmedica');
...
INSERT INTO define_secuencia_ws VALUES ('envbonis_real', 99, 900, 'traductor_in_envbonis_banmedica', 'traductor_out_envbonis_banmedica', 'BANMEDICA', '127.0.0.1', 'seq_puerto_banmedica');
