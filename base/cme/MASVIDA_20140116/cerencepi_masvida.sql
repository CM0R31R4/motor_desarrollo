...
begin
	...
	--Por ahora en duro
        ...
        exec_sp:= 'EXECUTE dbo.cerencepi ['||get_campo('EPIRUTPRESTADOR',xml2)||'],
                        ...
                        ['||get_campo('EPIFECCONTROL',xml2)||'], @AnamCodError OUTPUT, @AnamMensajeError OUTPUT ';
...
begin
        ...
        raise notice 'JCC_cerencepi_RECEIVE AnamCodError=% - AnamMensajeError=%',cod_resp1,msj_resp1;
