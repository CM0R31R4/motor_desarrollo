CREATE OR REPLACE FUNCTION traductor_in_certrapro_masvida(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	xml2:=proc_parser_input_certrapro(xml2);
	...
	--Por ahora en duro
        ...
        exec_sp:= 'EXECUTE dbo.certrapro '||get_campo('EPITIPODET',xml2)||',
...
CREATE OR REPLACE FUNCTION traductor_out_certrapro_masvida(varchar)
returns varchar as
$$
declare
        xml1            alias for $1;
...
begin
        ...
        raise notice 'JCC_certrapro_RECEIVE EpiCodError=% - EpiMensajeError=%',cod_resp1,msj_resp1;
