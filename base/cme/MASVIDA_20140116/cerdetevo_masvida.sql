CREATE OR REPLACE FUNCTION traductor_in_cerdetevo_masvida(varchar)
returns varchar as
$$
declare
        xml1    alias for $1;
...
begin
	...
	xml2:=proc_parser_input_cerdetevo(xml2);
	...
	--Por ahora en duro
        ...
        exec_sp:= 'EXECUTE dbo.cerdetevo '||get_campo('EPITIPODET',xml2)||',
...
CREATE OR REPLACE FUNCTION traductor_out_cerdetevo_masvida(varchar)
returns varchar as
$$
declare
        xml1            alias for $1;
...
begin
        ...
        raise notice 'JCC_cerdetevo_RECEIVE AnamCodError=% - AnamMensajeError=%',cod_resp1,msj_resp1;
